...
export const getBotConfig = async (barbershopId: string): Promise<BotConfig> => {
  try {
    ...
    if (dbConfig) {
      return {
        welcome_header:               dbConfig.welcomeMessage          ?? DEFAULT_BOT_CONFIG.welcome_header,
        ...
        // Fields not in DB schema — always use defaults
        end_session_message:          DEFAULT_BOT_CONFIG.end_session_message,
        name_validation_message:      DEFAULT_BOT_CONFIG.name_validation_message,
        no_slots_message:             DEFAULT_BOT_CONFIG.no_slots_message,
        cancel_no_appointments_message:   DEFAULT_BOT_CONFIG.cancel_no_appointments_message,
        cancel_list_message:              DEFAULT_BOT_CONFIG.cancel_list_message,
        cancel_success_message:           DEFAULT_BOT_CONFIG.cancel_success_message,
        reschedule_no_appointments_message: DEFAULT_BOT_CONFIG.reschedule_no_appointments_message,
        reschedule_list_message:          DEFAULT_BOT_CONFIG.reschedule_list_message,
        no_previous_appointments_message: DEFAULT_BOT_CONFIG.no_previous_appointments_message,
        rating_question_message:          DEFAULT_BOT_CONFIG.rating_question_message,
        rating_confirmation_message:      DEFAULT_BOT_CONFIG.rating_confirmation_message,
        promotions_message:               DEFAULT_BOT_CONFIG.promotions_message,
        instagram_message:                DEFAULT_BOT_CONFIG.instagram_message,
      };
    }

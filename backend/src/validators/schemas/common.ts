...
export const uuid = (label: string): z.ZodString => z.string().uuid(`ID do ${label} inválido`);
...
export const optionalString = (max = 500): z.ZodUnion<[z.ZodOptional<z.ZodString>, z.ZodLiteral<''>]> =>
...
export type DateYMD = z.infer<typeof dateYMD>;
export type TimeHM = z.infer<typeof timeHM>;
